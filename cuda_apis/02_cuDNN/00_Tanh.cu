...
int main() {
    ...
    // cudnnSetTensor4dDescriptor needs the format and data type of the input tensor
    // CUDNN_TENSOR_NCHW uses (N, C, H, W) format, and CUDNN_DATA_FLOAT uses FP32
    ...
    // cudnnSetActivationDescriptor needs the activation mode
    // CUDNN_ACTIVATION_TANH uses Tanh
